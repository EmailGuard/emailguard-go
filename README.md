# github.com/EmailGuard/emailguard-go/emailguardsdk
...
```bash
go get github.com/EmailGuard/emailguard-go/emailguardsdk
```
...
- [github.com/EmailGuard/emailguard-go/emailguardsdk (Go)](https://pkg.go.dev/github.com/EmailGuard/emailguard-go/emailguardsdk) (this package)
