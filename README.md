# github.com/EmailGuard/emailguard-go

Go SDK for the EmailGuard public API. This package is generated from the public OpenAPI spec.

## Links

- [EmailGuard website](https://emailguard.co)
- [API docs](https://emailguard.co/docs/api-reference)
- [Go SDK guide](https://emailguard.co/docs/api-reference/guides/sdk-go)
...
```bash
go get github.com/EmailGuard/emailguard-go
```
...
The SDK exposes one root package. API groups are services on the main client,
and request/response models are exported from the same package.
...
team, err := client.Teams.GetTeam(context.Background())
```
...
- [github.com/EmailGuard/emailguard-go (Go)](https://pkg.go.dev/github.com/EmailGuard/emailguard-go) (this package)
