...
func (r ApiGetBillingUsageRequest) Range_(range_ string) ApiGetBillingUsageRequest {
	r.range_ = &range_
	return r
}

// Custom range start (RFC3339 or YYYY-MM-DD); required when range&#x3D;custom
func (r ApiGetBillingUsageRequest) Start(start string) ApiGetBillingUsageRequest {
	r.start = &start
	return r
}

// Custom range end (RFC3339 or YYYY-MM-DD); required when range&#x3D;custom
func (r ApiGetBillingUsageRequest) End(end string) ApiGetBillingUsageRequest {
	r.end = &end
	return r
}

func (r ApiGetBillingUsageRequest) Execute() (*BillingUsageResponse, *http.Response, error) {
...
func (a *BillingAPIService) GetBillingUsageExecute(r ApiGetBillingUsageRequest) (*BillingUsageResponse, *http.Response, error) {
	var (
