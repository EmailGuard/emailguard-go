...
func (r ApiListNotificationEventsRequest) Execute() (*GetNotificationEventsResponse, *http.Response, error) {
...
*/
func (a *EventsAPIService) ListNotificationEvents(ctx context.Context) ApiListNotificationEventsRequest {
	return ApiListNotificationEventsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *EventsAPIService) ListNotificationEventsExecute(r ApiListNotificationEventsRequest) (*GetNotificationEventsResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EventsAPIService.ListNotificationEvents")
	if err != nil {
