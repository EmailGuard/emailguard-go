...
func (r ApiGetTeamRequest) Execute() (*GetPublicTeamResponse, *http.Response, error) {
...
*/
func (a *TeamsAPIService) GetTeam(ctx context.Context) ApiGetTeamRequest {
	return ApiGetTeamRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *TeamsAPIService) GetTeamExecute(r ApiGetTeamRequest) (*GetPublicTeamResponse, *http.Response, error) {
	var (
...
func (r ApiUpdateTeamRequest) UpdateTeamInput(updateTeamInput UpdateTeamInput) ApiUpdateTeamRequest {
	r.updateTeamInput = &updateTeamInput
	return r
}

func (r ApiUpdateTeamRequest) Execute() (*GetPublicTeamResponse, *http.Response, error) {
...
*/
func (a *TeamsAPIService) UpdateTeam(ctx context.Context) ApiUpdateTeamRequest {
	return ApiUpdateTeamRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetPublicTeamResponse
func (a *TeamsAPIService) UpdateTeamExecute(r ApiUpdateTeamRequest) (*GetPublicTeamResponse, *http.Response, error) {
	var (
